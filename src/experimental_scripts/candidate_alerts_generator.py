...
def fix_internal_alert(alert_entry, internal_source_id):
    ...
    release_triggers = alert_entry["release_triggers"]
    ...
    for trigger in event_triggers:
        ...
        #     release_trigger = list(filter(lambda x: x.type
        #                                   == trigger_type, release_triggers))
        #     if release_trigger:
        #         alert_level = release_trigger["details"]["alert_level"]
        #         source_id = release_trigger["source_id"]
        #         internal_alert_symbol = IAS_MAP[(alert_level, source_id)]

        #     trigger_list_str.append(internal_alert_symbol)
