...
def get_tsm_alerts(site_tsm_sensors, query_ts_end):
    ...
    for sensor in site_tsm_sensors:
        ...
        if tsm_alert_entries:
            ...
            alert_symbol = retrieve_data_from_memcache("operational_trigger_symbols", {
                                                             "alert_level": entry.alert_level, "source_id": subsurface_source_id}, retrieve_attr="alert_symbol")
...
def get_site_public_alerts(active_sites, query_ts_start, query_ts_end, do_not_write_to_db):
    ...
    for site in active_sites:
        ...
        public_alert_symbol = retrieve_data_from_memcache(
            "public_alert_symbols", {"alert_level": highest_public_alert}, retrieve_attr="alert_symbol")
