...
class GsmCsqLogs(DB.Model):
    ...
    gsm_id = DB.Column(
        DB.Integer, DB.ForeignKey("mia_comms_db_3.gsm_modules.gsm_id"))
...
class SimPrefixes(DB.Model):
    ...
    network_id = DB.Column(DB.Integer, DB.ForeignKey(
        "mia_comms_db_3.network_carrier.network_id"))
    gsm_id = DB.Column(DB.Integer, DB.ForeignKey(
        "mia_comms_db_3.gsm_modules.gsm_id"))
